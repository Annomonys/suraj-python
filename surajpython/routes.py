...
from surajpython import app, db, bcrypt,mail
from surajpython.forms import (RegistrationForm, LoginForm, UpdateAccountForm, PostForm, RequestResetForm, ResetPasswordForm)
from surajpython.models import User, Post
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(user.password, form.password.data):
            ...
            flash('Login Successful. You have Enter the userpannel', 'success')
